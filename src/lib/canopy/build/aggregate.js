import { getCanopyCollection } from "./shape.js";
import { getEntries, getLabel } from "../iiif/label.js";
import { getUniqueSlug } from "./slug.js";
import { log } from "./log.js";
import { getRootCollection, getBulkManifests } from "./request.js";
import { buildIndexData } from "./search.js";
import { buildFacets } from "./facets.js";
import { promises as fs } from "fs";
import * as fsSync from "fs";

export const build = async (env) => {
  const { baseUrl } = env;
