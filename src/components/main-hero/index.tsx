  ...
  return (
    <div className="relative flex flex-col gap-10 items-center justify-center w-full lg:max-w-7xl mx-auto">
      <div className="grid grid-cols-[200px_1fr_200px] gap-5 items-center justify-center w-full">
        ...
        <h1 className="text-2xl md:text-4xl text-center uppercase"><span className='text-xl md:text-2xl'>200 år med</span><br />vidunderlig vitenskap</h1>
        <div>{' '}</div>
      </div>
      ...
      <div className="flex flex-row gap-5 items-center justify-between w-3/4">
        <p className="text-xl aspect-square flex items-center justify-center font-bold md:text-2xl rounded-full bg-um-arkeologi-solid text-background px-4 py-2">1825</p>
        <p className="text-xl md:text-2xl text-center">Universitetet i Bergen, Universitetsmuseet og Universitetsbiblioteket</p>
        <p className="text-xl aspect-square flex items-center justify-center font-bold md:text-2xl rounded-full bg-um-arkeologi-solid text-background px-4 py-2  ">2025</p>
      </div>
    </div>
  )
}