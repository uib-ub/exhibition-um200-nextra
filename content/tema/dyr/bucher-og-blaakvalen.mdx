...
<Figure className="feature" image="/images/dyr/ubb-ms-2310.jpg" alt="Blåhval" width={2000} height={1000}>
  <Figure.Content>
    <Figure.Description>
...
<Work className="feature" iiifContent="https://api.ub.uib.no/items/ubb-bs-ok-00067?as=iiif">
  <Work.Content>
    <Work.Description>
...
<Figure className="feature" mode="portrait" image="/images/dyr/ubb-ms-1478-2-003.jpg" alt="Sjøstjerne" width={2000} height={1000}>
  <Figure.Content>
    <Figure.Description>
