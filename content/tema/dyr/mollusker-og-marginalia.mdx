...
<Figure className="feature" image="/images/dyr/ubb-ms-0644-000.jpg" alt="Tegninger av skjell" width={2000} height={1000}>
  <Figure.Content>
    <Figure.Description>
      Illustrasjon fra «Bløddyrene (Mollusca) eller Skalbærende (Conchiferæ), tegnet af Johan Schnelle, deels efter Naturen og deels efter Tegninger. 1864» av Johan Joachim Schnelle. Universitetsbiblioteket i Bergen.
    </Figure.Description>
  </Figure.Content>
</Figure>
...
<Figure className="feature" image="/images/dyr/ubb-spesmag-o-0416.jpg" alt="Åpen bok med tegninger i margen" width={2000} height={2000}>
  <Figure.Content>
    <Figure.Description>
      Oppslag fra «Beskrivelser og Iagttagelser over nogle mærkelige eller nye i Havet ved den Bergenske Kyst Dyr» av Michael Sars (Bergen 1835), med Johan Joachim Schnelles marginalia og illustrasjoner. Universitetsbiblioteket i Bergen.
    </Figure.Description>
  </Figure.Content>
</Figure>
...
<Figure className="feature" mode="portrait" image="/images/dyr/ubb-ms-0644-003.jpg" alt="Tegninger av skjell" width={2000} height={1000}>
  <Figure.Content>
    <Figure.Description>
      Illustrasjon fra «Bløddyrene (Mollusca) eller Skalbærende (Conchiferæ), tegnet af Johan Schnelle, deels efter Naturen og deels efter Tegninger. 1864» av Johan Joachim Schnelle. Universitetsbiblioteket i Bergen.
    </Figure.Description>
