...
<Work className="feature" iiifContent="https://api.ub.uib.no/object/ubb-wil-a-066?as=iiif">
  <Work.Content>
    <Work.Description>
...
For snart 200 år siden måtte man i tillegg til å ta med penger, piller og pass, også ta med sitt attesterte sunnhetssertifikat. På samme måte som skip måtte ha en attest på at byen de forlot ikke hadde noe pågående smitteutbrudd, måtte også enkeltpersoner ha dette med seg på sin ferd. I 1831 dro vår kjære vandrerske, Catharina Hermine Kølle, fra København til Christiania. Med seg hadde også hun sitt Sundheds-Certificat med følgende påskrift:
...
<Work className="feature" iiifContent="https://api.ub.uib.no/object/ubb-ms-0659-d-08-05?as=iiif">
  <Work.Content>
    <Work.Description>
...
*En variant av teksten er tidligere publisert i Khrono, 13.03.2020.*
