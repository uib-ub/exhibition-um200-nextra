...
description: En fortelling om normaltid.
keywords: 
  - tiden
  - klokke
  - jernbanetid
...
<Figure mode="portrait" image="/images/tid-og-rom/ubb-librar-f-0109-03-utsnitt-a.jpg" alt="Tegning av gammel klokke" width={2000} height={1000}>
  <Figure.Content>
    <Figure.Description>
      Plansje over urverk fra Manuskript- og librarsamlingens «Recueil de Planches, sur les Sciences, les Arts Liberaux, et les Arts Mechaniques, avec leur Explication.”, bind 3. Universitetsbiblioteket i Bergen.
    </Figure.Description>
  </Figure.Content>
</Figure>
...
<Figure mode="portrait" image="/images/tid-og-rom/ubb-librar-f-0109-03-utsnitt-b.jpg" alt="Tegning av gammel klokke" width={2000} height={1000}>
  <Figure.Content>
    <Figure.Description>
      Plansje over urverk fra Manuskript- og librarsamlingens «Recueil de Planches, sur les Sciences, les Arts Liberaux, et les Arts Mechaniques, avec leur Explication.”, bind 3. Universitetsbiblioteket i Bergen.
    </Figure.Description>
