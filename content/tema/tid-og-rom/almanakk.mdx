...
{/*
<Figure image="/images/fisk/ubb-ms-0311-a-002.jpg" alt="Tegning av ålekvabbe omgitt av håndskrevet tekst. " width={2000} height={1000}>
  <Figure.Content>
    <Figure.Description>
...
{/*
<Work className="feature" iiifContent="https://api.ub.uib.no/items/ubb-ms-0380?as=iiif">
  <Work.Content>
    <Work.Description>
